...
break
case 'command': {
await chika.sendListMenu(from, `Selamat ${salam} kak ${pushname}` , lang.list(pushname) , 'PILIH MENU BOT', {quoted: fkontak})
}
break
case 'menu': {
if(typemenu == 'image'){
await chika.send5ButImg(from, `` + '' + lang.menu(botname, pushname, salam), `© ${ownername}`,thumb, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "List Menu","id": 'command'}},{"quickReplyButton": {"displayText": "Jadwal Pelajaran","id": 'jadwalpelajaran'}}] )
}
if(typemenu == 'gif'){
...
var riych = await getBuffer(picak+'Jadwal Pelajaran')
await chika.send5ButImg(from, `` + '' + lang.jadwalpelajaran(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'senin':
var riych = await getBuffer(picak+'Jadwal Hari Senin X TKJ 2')
await chika.send5ButImg(from, `` + '' + lang.jadwalharisenin(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'selasa':
var riych = await getBuffer(picak+'Jadwal Hari Selasa X TKJ 2')
await chika.send5ButImg(from, `` + '' + lang.jadwalhariselasa(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'rabu':
var riych = await getBuffer(picak+'Jadwal Hari Rabu X TKJ 2')
await chika.send5ButImg(from, `` + '' + lang.jadwalharirabu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'kamis':
var riych = await getBuffer(picak+'Jadwal Hari Kamis X TKJ 2')
await chika.send5ButImg(from, `` + '' + lang.jadwalharikamis(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'jumat':
var riych = await getBuffer(picak+'Jadwal Hari Jumat X TKJ 2')
await chika.send5ButImg(from, `` + '' + lang.jadwalharijumat(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'searchmenu':
